(function () {
  ...
  var tokenKey = 'internguide_university_admin_token';
  var userKey = 'internguide_university_admin_user';
  ...
  async function ensureUniversityAdmin() {
    var token = getToken();
  ...
  function attachLogout() {
    var logout = getElement('university-logout-link');
  ...
  window.InternGuideUniversity = {
    apiBase: API_BASE,
    attachLogout: attachLogout,
    buildQuery: buildQuery,
    clearSession: clearSession,
    ensureUniversityAdmin: ensureUniversityAdmin,
    ...
    dashboard: function () {
      return request('/university/dashboard', { auth: true });
    },
    listStudents: function (params) {
      return request('/university/students' + buildQuery(params), { auth: true });
    },
    getStudent: function (id) {
      return request('/university/students/' + encodeURIComponent(id), { auth: true });
    },
    verifyStudent: function (id, data) {
      return request('/university/students/' + encodeURIComponent(id) + '/verify', { method: 'PATCH', body: data, auth: true });
    },
    listApprovals: function (params) {
      return request('/university/internship-approvals' + buildQuery(params), { auth: true });
    },
    getApproval: function (id) {
      return request('/university/internship-approvals/' + encodeURIComponent(id), { auth: true });
    },
    reviewApproval: function (id, data) {
      return request('/university/internship-approvals/' + encodeURIComponent(id) + '/review', {
        method: 'PATCH',
        body: data,
        auth: true,
      });
    ...
    listApplications: function (params) {
      return request('/university/applications' + buildQuery(params), { auth: true });
    },
    listNotifications: function (params) {
      return request('/university/notifications' + buildQuery(params), { auth: true });
    },
    markNotificationRead: function (id) {
      return request('/university/notifications/' + encodeURIComponent(id) + '/read', { method: 'PATCH', auth: true });
    },
    markAllNotificationsRead: function () {
      return request('/university/notifications/read-all', { method: 'PATCH', auth: true });
    },
    listAuditLogs: function (params) {
      return request('/university/audit-logs' + buildQuery(params), { auth: true });
    },
  };
})();
